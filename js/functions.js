...
function formatPurport(text) {
    ...
    const sanskritWords = new Set([ 'bhakti', 'bhakta', 'buddhi', 'buddhi-yoga', 'buddhi-yogam', 'bhakti-yoga', 'bhakti-yogam', 'yoga', 'karma-yoga', 'karma', 'svayam', 'Brahmā', 'pavitram', 'divyam', 'ajam', 'vibhum', 'sarvam', 'etad', 'manye', 'sat', 'cit', 'vigraha', 'nityo', 'tava', 'vedas', 'kena', 'jagat', 'surabhi', 'Brahmājyoti', 'mahat-tattva', 'asura', 'avyakta', 'nirukti', 'vai', 'sma', 'ca', 'om', 'acintya', 'acyuta', 'adhidaivatam', 'advaita', 'ajam', 'akarma', 'arca-vigraha', 'asat', 'yama', 'niyama', 'sura', 'bhaga', 'van', 'brahmacarya', 'brahma', 'jyoti', 'caturmasya', 'citi', 'deva', 'nandana', 'dharma', 'guru', 'japa'
